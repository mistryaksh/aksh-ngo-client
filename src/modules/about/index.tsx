               ...
               <div className="grid grid-cols-1 sm:grid-cols-2">
                    <div className="w-full">
                         ...
                         <p className="text-sm sm:text-base text-gray-500 tracking-normal sm:tracking-wide font-light leading-7 mb-5 sm:mb-10">
                              In 2020, the non-profit organization "Health Empowerment Initiative" recognized the urgent
                              need for health awareness in a diverse urban community facing high rates of HIV/AIDS and
                              cancer.
                         </p>
                         <p className="text-sm sm:text-base text-gray-500 tracking-normal sm:tracking-wide font-light leading-7 mb-5 sm:mb-12">
                              Determined to address both public health challenges simultaneously, the organization
                              initiated a comprehensive health awareness program. This case story details the successful
                              implementation of dual HIV and cancer awareness initiatives.
                         </p>
                    ...
                    <div className="relative w-full bg-white sm:block hidden">
                         ...
                         <div className="absolute -bottom-8 left-28">
                              <img
                                   src="https://images.pexels.com/photos/17728025/pexels-photo-17728025/free-photo-of-stories-untold.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                                   alt="about-2"
