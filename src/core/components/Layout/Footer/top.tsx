     ...
     return (
          <div className="grid grid-cols-12 gap-x-20 gap-y-8 mb-10 sm:mb-28 w-full">
               <div className="col-span-12 sm:col-span-3">
                    ...
                    <h6 className="text-2xl uppercase font-mono">Infinity</h6>
               </div>
               <div className="col-span-12 sm:col-span-4">
                    <h4 className="text-sm sm:text-lg font-medium text-white mb-3.5 sm:mb-6">Contact Info</h4>
                    <ul className="flex flex-col items-start gap-y-2.5 sm:gap-y-4 text-white text-xs sm:text-base font-light tracking-wide w-full">
                         <li>
                              <address className="capitalize">Address: NGO DEMO ADDRESS</address>
                         </li>
                         <li>Phone: +91 1234567890</li>
                         <li>Email: finiteinfinitysolution@gmail.com</li>
                    </ul>
               </div>
               <div className="col-span-12 sm:col-span-4">
                    ...
                    <ul className="flex flex-col items-start gap-y-2.5 sm:gap-y-4">
                         {links.map((link, index) => (
                              <li key={index} className={STYLES.LINK + " text-white font-light tracking-wide"}>
